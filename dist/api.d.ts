...
export interface DeepgramTranscriber {
    ...
    model?: 'nova-2' | 'nova-2-general' | 'nova-2-meeting' | 'nova-2-phonecall' | 'nova-2-finance' | 'nova-2-conversationalai' | 'nova-2-voicemail' | 'nova-2-video' | 'nova-2-medical' | 'nova-2-drivethru' | 'nova-2-automotive' | string;
    ...
    language?: 'cs' | 'da' | 'da-DK' | 'nl' | 'en' | 'en-US' | 'en-AU' | 'en-GB' | 'en-NZ' | 'en-IN' | 'nl-BE' | 'fr' | 'fr-CA' | 'de' | 'el' | 'hi' | 'hi-Latn' | 'id' | 'it' | 'ja' | 'ko' | 'ko-KR' | 'no' | 'pl' | 'pt' | 'pt-BR' | 'ru' | 'es' | 'es-419' | 'sv' | 'sv-SE' | 'tr' | 'uk';
...
export interface RimeAIVoice {
    ...
    provider: 'rime-ai';
    /** This is the provider-specific ID that will be used. */
    voiceId: 'kai' | 'zion' | 'xavier' | 'marty' | 'hudson' | 'savannah' | 'colette' | 'daphne' | 'aurora' | 'nova' | string;
    /**
     * This is the speed multiplier that will be used.
     * @min 0
     * @example null
...
export interface CreateAssistantDTO {
    ...
    model?: OpenAIModel | TogetherAIModel | AnyscaleModel | OpenRouterModel | PerplexityAIModel | DeepInfraModel | GroqModel | CustomLLMModel;
    /**
     ...
     */
    clientMessages?: ('status-update' | 'speech-update' | 'transcript' | 'hang' | 'function-call' | 'metadata' | 'conversation-update')[];
    /**
     ...
     */
    serverMessages?: ('status-update' | 'transcript' | 'hang' | 'function-call' | 'end-of-call-report' | 'conversation-update')[];
    /**
